        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
          {links.map((link) => (
            <a
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r ${link.color} text-white font-semibold text-sm shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-200`}
            >
              {link.icon}
              {link.label}
            </a>
